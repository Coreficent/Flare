...
int main(int argc, char** argv)
{
	...
	static auto cake_texture = Flare::Texture::Resource_manager::getTexture("texture/cake.png");
	...
	static auto texture_arrow = Flare::Texture::Resource_manager::getTexture("texture/arrow.png");
